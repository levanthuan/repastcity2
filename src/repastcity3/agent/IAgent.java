...
public interface IAgent {
	...
	/**
	 * Controls the agent. This method will be called by the scheduler once per iteration.
	 * Kiểm soát các đại lý. Phương pháp này sẽ được gọi bởi bộ lập biểu một lần mỗi lần lặp.
	 */
