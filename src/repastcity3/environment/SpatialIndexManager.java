...
public abstract class SpatialIndexManager implements Cacheable {
	...
	// Link spatial indices to their geographies: Liên kết các chỉ số không gian vào các vùng địa lý của chúng.
	...
	/**
	 * Find out whether or not this <code>SpatialIndexManager</code> has an index for the given geography.
	 */
